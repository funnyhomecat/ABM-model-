...
to create-studenthousing
  let num-studenthousing 10 ; Adjust the number of student housing patches as needed
...
to find-new-spot-new
  ...
  ifelse student? and any? student-only-patches [
    ...
    ; Move to a random location within the target patch
