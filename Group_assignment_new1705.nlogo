...
to find-new-spot-new
  ...
  ; If there is no available housing nearby, move randomly until an unoccupied patch is found
  [ rt random-float 360
    fd random-float 10
    if any? other turtles-here [ find-new-spot-new] ; keep going until we find an unoccupied patch
