...
to find-new-spot-new
  ...
  ; Check for available student-only housing
  let student-only-patches patches with [studenthousing? and not any? other turtles-here]

  ; Check for available non-student housing
  let non-student-patches patches with [not studenthousing? and not any? other turtles-here]
